...
transform_stock_data_spark_task=SparkSubmitOperator(
    task_id='transform_stock_data_script',
    application='/opt/jupyter/notebooks/transform_stock_data.py',
    name='transform_stock_data',
    ...
    application_args=[
        ...
        '--output_path','/opt/airflow/data/processed/stock/',
        '--checkpoint_path','/opt/airflow/data/checkpoints/stock/',
        '--execution_date','{{ ds }}',
        '--timeout_minutes', '10'
    ],
    conf={
